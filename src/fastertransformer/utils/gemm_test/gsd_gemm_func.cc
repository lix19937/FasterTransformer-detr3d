...
#include "src/fastertransformer/utils/gemm_test/gsd_gemm_func.h"

namespace fastertransformer {

template<typename T>
void generate_gsd_gemm_config(
    //////// 1               332         4                 960/4
    int batch_size,
    int seq_len,
    int head_num,
    ...
    bool isAppend)
{
    ...
    // algo_map_.size: 0,  1_512_5_256_1
    // algo_map_.size: 0,  8_512_512_32_1
    // algo_map_.size: 0,  8_512_32_512_1

    // -->> algo_map_.size: 0,  1_332_960_960_0 36
    // -->> algo_map_.size: 0,  1_8_8_960_0 2
    // -->> algo_map_.size: 0,  4_332_332_240_0 6
    // -->> algo_map_.size: 0,  4_332_240_332_0 6
    ...
    K[0] = N[0];
    strcpy(mess[0], "1_332_960_960_0");

    M[1] = 8;
    N[1] = 8;
    K[1] = 960;  // hidden_units_
    strcpy(mess[1], "1_8_8_960_0");

// 1_332_2880_960_1
    M[2] = 332;
    N[2] = 2880;
    K[2] = 960;  // hidden_units_
    strcpy(mess[2], "1_332_2880_960_0");

/////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////  TN
    M[3] = seq_len;
    N[3] = seq_len;
    K[3] = size_per_head;  // 240
    batchCount[3] = batch_size * head_num;
    strcpy(mess[3], "attention batched Gemm1 4_332_332_240_0");

    /////////////////////////////////////////////////  NN
    M[4] = seq_len;
    N[4] = size_per_head;  // 240
    K[4] = seq_len;
    batchCount[4] = batch_size * head_num;
    strcpy(mess[4], "attention batched Gemm2 4_332_240_332_0");

    /////////////////////////////////////////////////  NN
    M[5] = batch_size * seq_len;
    N[5] = head_num * size_per_head;  // hidden_units_
    K[5] = N[5];
    batchCount[5] = 3;
    strcpy(mess[5], "from_tensor * weight_QKV BatchGemm 3_332_960_960_0");
    ...
    for (int i = 0; i < gemm_num; ++i) {
        ...
        T** dAarray = darray;// weights
        T** dBarray = darray + 4; // x ;    A * B 
        T** dCarray = darray + 8;
        ...
        if (i < (2+1) && data_type != FLOAT_DATATYPE) {
...
template void generate_gsd_gemm_config<float>(
    int batch_size, int seq_len, int head_num, int size_per_head, void* buffer, bool isAppend);
template void generate_gsd_gemm_config<half>(
    int batch_size, int seq_len, int head_num, int size_per_head, void* buffer, bool isAppend);

#ifdef ENABLE_BF16
template void generate_gsd_gemm_config<__nv_bfloat16>(
    int batch_size, int seq_len, int head_num, int size_per_head, void* buffer, bool isAppend);
#endif
