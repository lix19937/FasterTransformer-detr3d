...
public:
    ...
    explicit cublasAlgoMap(const std::vector<std::string> &choices, const std::vector<std::string> spchoices = {});
    ...
    void loadGemmConfig(const std::vector<std::string> &choices);
    void loadSpGemmConfig(const std::vector<std::string> &choices);
