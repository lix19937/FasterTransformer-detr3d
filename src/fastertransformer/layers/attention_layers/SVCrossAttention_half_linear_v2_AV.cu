...
template<>
void SVCrossAttentionLayer<half>::__forward_half_linear_v2_AV_branch(
    ...
    const CAttentionWeight<half>* weights)
{
    ...
    avt::half_linear_v2::ReferencePointsNorm(d_rp_norm_,                /* rp after norm; [1, 4, num_query] */
    ...
    avt::half_linear_v2::L2IxReferencePoints(d_rp_matmuled_,          /* rp after matmul; [1, NC, 4, L] */
    ...
    avt::half_linear_v2::ReferencePointsCamAndMask(
    ...
    avt::half_linear_v2::AttentionWeightsFc(d_attention_weights_output_, /* output; [L, 24] , no bias*/
    ...
    avt::half_linear_v2::BatchGridsampleTwoMulReduceSum(
    ...
    avt::half_linear_v2::OutputProjFc(d_output, /* last output;  [L, embed_dims] */
    ...
    avt::half_linear_v2::PositionEncoder(d_pos_feat,       /* last output;  [L, embed_dims] */
...
template<>
void SVCrossAttentionLayer<half>::__forward_magic_half_linear_v2_AV_branch(
    std::vector<fastertransformer::Tensor>* output_tensors,
    const std::vector<fastertransformer::Tensor>* input_tensors,
    const CAttentionWeight<half>* weights,
    ...
    cudaStream_t stream)
{
    ...
    /// half --> half
    avt::half_linear_v2::L2IxReferencePoints((half*)d_rp_matmuled_,   /* rp after matmul; [1, NC, 4, L] */
    ...
    avt::half_linear_v2::ReferencePointsCamAndMask(d_fs_mask_,  /* uint8_t, last out; [B, Ch, L, NC, 1, 1] */
