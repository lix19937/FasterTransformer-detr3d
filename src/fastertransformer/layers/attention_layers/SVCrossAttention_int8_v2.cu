...
template<>
void SVCrossAttentionLayer<half>::__forward_fake_int8_v2_branch(
    ...
    const CAttentionWeight<half>* weights)
{
    ...
    fake_int8_v2::ReferencePointsNorm(d_rp_norm_,                /* rp after norm; [1, 4, num_query] */
    ...
    fake_int8_v2::L2IDivImgShpe(d_l2i_norm_,  /* [NC, 4, 4] */
    ...
    fake_int8_v2::L2IxReferencePoints((half*)d_rp_matmuled_,    /* rp after matmul; [1, NC, 4, L] */
    ...
    fake_int8_v2::ReferencePointsCamAndMask(d_fs_mask_,  /* uint8_t, last out; [B, Ch, L, NC, 1, 1] */
                                            d_rpc_norm_, /* half, after norm which as grid sample in;  [1, NC, L, 2] */
                                            (const half*)d_rp_matmuled_, /* [1, NC, 4, L] */
                                            nc,
                                            4u,
                                            seq_len,
                                            stream_);

    fake_int8_v2::AttentionWeightsFc(d_attention_weights_output_, /* output; [L, 24] , no bias*/
    ...
    fake_int8_v2::BatchGridsampleTwoMulReduceSum(
    ...
    fake_int8_v2::OutputProjFc(d_output, /* last output;  [L, embed_dims] */
    ...
    fake_int8_v2::PositionEncoder(d_pos_feat,       /* last output;  [L, embed_dims] */
...
template<>
void SVCrossAttentionLayer<half>::__forward_magic_fake_int8_v2_branch(
    std::vector<fastertransformer::Tensor>* output_tensors,
    const std::vector<fastertransformer::Tensor>* input_tensors,
    const CAttentionWeight<half>* weights,
