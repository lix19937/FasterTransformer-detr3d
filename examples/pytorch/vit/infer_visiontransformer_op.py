...
def setup(args):
    ...
    model = VisionTransformer(config, args.img_size, zero_head=False, num_classes=21843)
...
def run_vitnv_op(args, config, model, images, use_fp16):
    ...
    ##run pytorch op  cpp VisionTransformerClass
    try:
        print('use torch.classes.VisionTransformer.Class #1')
        ...
        print('use torch.classes.VisionTransformerClass #2')
